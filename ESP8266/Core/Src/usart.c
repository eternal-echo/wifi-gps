...
/* USER CODE BEGIN 1 */
extern void Wifi_UART_RxCpltCallback(UART_HandleTypeDef *UartHandle);
extern void BDS_UART_RxCpltCallback(UART_HandleTypeDef *UartHandle);
// extern void Debbug_UART_RxCpltCallback(UART_HandleTypeDef *UartHandle);
/**
...
extern void BDS_UART_RxHalfCpltCallback(UART_HandleTypeDef *UartHandle);
/**
