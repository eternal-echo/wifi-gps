...
// static WifiUsart::ESP8266_Status runAtCmd(uint8_t* cmd, uint32_t Length, const uint8_t* Token);
// static WifiUsart::ESP8266_Status getData(uint8_t* Buffer, uint32_t Length, uint32_t* RetLength);
...
//  memset(AtCmd, 0x00, MAX_AT_CMD_SIZE);
//  sprintf((char*)AtCmd, "ATE0\r\n");
//  Ret = runAtCmd(AtCmd, strlen((char*)AtCmd), AT_OK_STRING);
...
/**
  ...
  * @retval ESP8266_Status::ESP8266_OK on sucess, ESP8266_Status::ESP8266_ERROR otherwise.
  */
WifiUsart::ESP8266_Status WifiUsart::ESP8266_Restart(void)
{
  // WifiUsart::ESP8266_Status Ret;
...
/**
  ...
  * @param  Mode: a ESP8266_Mode to choose the Station or AccessPoint mode.
...
/**
  ...
  * @retval  Returns ESP8266_AT_COMMAND_OK on success and ESP8266_AT_COMMAND_ERROR otherwise.
  */
WifiUsart::ESP8266_Status WifiUsart::ESP8266_CloseConnection(const uint8_t channel_id)
{
